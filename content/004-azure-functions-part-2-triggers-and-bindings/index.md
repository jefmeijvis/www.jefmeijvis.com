...
![A trigger, input and output binding make up this Azure function](images/overview-trigger-binding-example.png)
...
![Available triggers in Azure Functions](images/table-1.png)
...
![Available input bindings in Azure Functions](images/table-2.png)
...
![Available output bindings in Azure Functions](images/table-3.png)
